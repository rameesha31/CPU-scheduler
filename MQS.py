...
from first import Process, read_processes_from_dataframe, multilevel_queue_scheduling, evaluate_performance
        ...
        def animate():
            ...
            if tab_isplaying and tab_count < len(frames):
                ...
                if tab_count == len(frames)-20:
                    ...
                    def next():
                        app.destroy()
                        subprocess.run([sys.executable, 'Eval.py'])
